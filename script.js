...
// div.innerHTML = "<div class='div-inner'>Text</div>";

// let inner = document.querySelector(".div_inner");
// inner.insertAdjacentHTML("afterend","<span class='span-class'>Span1</span>");
// inner.insertAdjacentHTML("afterend","<span class='span-class'>Span2</span>");
